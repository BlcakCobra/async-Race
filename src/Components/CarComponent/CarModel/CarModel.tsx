...
const CarModel:React.FC<CarModelType> = ({car}) => {
    return (
        <svg
            width="120"
            height="120"
            viewBox="0 0 300 600"
            style={{ color: car.color,transform:"rotate(90deg)" }}
            xmlns="http://www.w3.org/2000/svg"
        >
            <rect x="60" y="100" width="180" height="400" rx="40" ry="40" fill="currentColor" stroke="#333" strokeWidth="4" />

            <rect x="90" y="130" width="120" height="80" rx="10" ry="10" fill="#ccc" stroke="#666" strokeWidth="2" />
            <rect x="90" y="230" width="120" height="80" rx="10" ry="10" fill="#ccc" stroke="#666" strokeWidth="2" />
            <rect x="90" y="330" width="120" height="80" rx="10" ry="10" fill="#ccc" stroke="#666" strokeWidth="2" />
