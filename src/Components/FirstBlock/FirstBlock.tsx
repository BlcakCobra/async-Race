...
const FirstBlock = () => (
  <section className={styles.firstBlock}>
    <div className={styles.backgroundPattern}>
      <img src={bluePattern} alt="Decorative blue pattern" className={styles.backgroundImage} />
    </div>

    <div className={styles.infoRow}>
      <h2 className={styles.infoText}>OCTOBER 15–17, 2052</h2>
      <h2 className={styles.infoText}>Horizon Convention Center, TechCity, Utopolis</h2>
    </div>
